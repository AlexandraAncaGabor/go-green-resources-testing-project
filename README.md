...
| [TC-031]    | Check that the page "Exploatarea piatră vs pădure" opens if it is selected from the menu |
...
| [TC-035]   | Check that the page "Zăcământ Moldova Nouă" opens if it is selected from the menu |
| [TC-036]  | Check that the text from "Zăcământ Moldova Nouă" page is properly alligned |
| [TC-037]  | Check that the page "Pădurile nimănui" opens if it is selected from the menu |
...
| [TC-041]  | Check that the page "Deșeuri menajere" opens if it is selected from the menu |
| [TC-042]   |  Check that the text from "Deșeuri menajere" page is properly alligned |
...
| [TC-045]  |  Check that the images from "Activități" are properly alligned |
| [TC-046]   |  Check that the page "Perimetrul minier Băiuţ" is displayed properly |
| [TC-047]    |  Check that the text from "Perimetrul minier Băiuţ" page is properly alligned |
| [TC-048]    |  Check that the images from "Perimetrul minier Băiuţ" are properly alligned |
...
| [TC-052] |  Check that the page "Perimetrul minier Borșa" opens |
| [TC-053]  |  Check that the text from "Perimetrul minier Borșa" page is properly alligned |
| [TC-054]  |  Check that the images from "Perimetrul minier Borșa" are properly alligned |
| [TC-055]  |  Check that the page "Perimetrul minier Nistru – Băița" opens |
| [TC-056]   |  Check that the text from "Perimetrul minier Nistru – Băița" page is properly alligned |
| [TC-057]   |  Check that the images from "Perimetrul minier Nistru – Băița" page are properly alligned |
| [TC-058]   |  Check that the page "Iaz de decantare Tăuții de Sus" opens |
| [TC-059]  |  Check that the text from "Iaz de decantare Tăuții de Sus" page is properly alligned |
| [TC-060]  |  Check that the images from "Iaz de decantare Tăuții de Sus" page are properly alligned |
| [TC-061] |  Check that the page "Iaz de decantare Bozânta" opens |
| [TC-062] |  Check that the text from "Iaz de decantare Bozânta" page is properly alligned |
| [TC-063] |  Check that the images from "Iaz de decantare Bozânta" page are properly alligned |
...
| [TC-067] |  Check that the page "Depozitul ecologizat de deșeuri menajere din Borșa" is displayed properly |
| [TC-068] |  Check that the text from "Depozitul ecologizat de deșeuri menajere din Borșa" page is properly alligned |
| [TC-069] |  Check that the images from "Depozitul ecologizat de deșeuri menajere din Borșa" page are properly alligned |
| [TC-070] |  Check that the page "Cariera Răzoare" is displayed properly |
| [TC-071] |  Check that the text from "Cariera Răzoare" page is properly alligned |
| [TC-072] |  Check that the images from "Cariera Răzoare" page are properly alligned |

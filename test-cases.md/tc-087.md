...
| 5  | Enter an invalid email   (e.g. abc@ )               |Invalid email is added in the field |
| 6   | Click on "Trimite mesajul" button                  | Error message is displayed  |
